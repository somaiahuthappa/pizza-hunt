...
// stores connected database object when connection is complete
// then event listemer is created when connection to DB is opened using indexdDB.open()
let db;
// establish a connection to IndexDB database called 'pizza_hunt' and set it to version 1

const request = indexedDB.open('pizza_hunt', 1);
// container that stores data is object store
